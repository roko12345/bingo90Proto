package com.kraljevic.bingo.test;

import com.kraljevic.bingo.Strip;
import com.kraljevic.bingo.Ticket;
...
public class BingoStripTest {
    ...
    @Test
    public void tousandTimesCheckEveryRowHasExactlyFiveNumbersTest() {
    ...
    @Test
    public void tousandTimesNoEmptyColumnsTest() {
        for (int i = 0; i < 10000; i++) {
            strip = new Strip();
            noEmptyColumnsOnAnyTicketTest();
        }
